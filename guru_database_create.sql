...
GRANT insert, delete, update, select ON TABLE sfg_prod.* TO sfg_prod_user@localhost;
GRANT insert, delete, update, select ON TABLE sfg_dev.* TO sfg_dev_user@localhost;
GRANT insert, delete, update, select ON TABLE sfg_prod.* TO sfg_prod_user@'%';
GRANT insert, delete, update, select ON TABLE sfg_dev.* TO sfg_dev_user@'%';
